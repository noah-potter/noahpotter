...
export const variables = {
  ...
  footerBackground: "rgb(48, 68, 50)",
  projectsBackground: "rgb(48, 68, 50)",
  dividerBackground: "rgb(169, 115, 47)",
  lightDividerBackground: blue500.rgbString(),
  nonActiveCounterBackground: grey500.rgbString(),
  activeCounterBackground: "rgb(169, 115, 47)",
  ...
  guestPage: { background: blue300.rgbString() },
  card: { light: { divider: `1px solid ${lighterGrey.rgbString()}` } },
  input: {
    background: lighterestGrey.rgbString(),
    hover: { background: lightestGrey.rgbString() },
    focus: { background: lighterGrey.rgbString() }
  },
  button: {
    group: { border: `1px solid ${darkBorder.rgbString()}` },
    dark: {
      flat: {
        hover: { background: light200.rgbString() },
        active: { background: light500.rgbString() },
        disabled: { color: light300.rgbString() },
        primary: { color: red500.rgbString() },
        default: { color: white.rgbString() },
        success: { color: green500.rgbString() },
        yellow: { color: yellow500.rgbString() }
      },
      raised: {
        hover: { background: light100.rgbString() },
        active: { background: light500.rgbString() },
        disabled: { color: light300.rgbString() },
        primary: { color: red500.rgbString() },
        default: { color: white.rgbString() },
    ...
    light: {
      flat: {
        hover: { background: dark100.rgbString() },
        active: { background: dark500.rgbString() },
        focus: { background: dark100.rgbString() },
        disabled: { color: dark300.rgbString() },
        primary: { color: red500.rgbString() },
        default: { color: textBlack.rgbString() },
        success: { color: green500.rgbString() }
      },
      raised: {
        hover: { background: light100.rgbString() },
  ...
  colors: {
    ...
    yellow: { main: yellow500.rgbString() }
  },
  calendar: {
    background: white.rgbString(),
    border: `1px solid ${darkBorder.rgbString()}`,
    title: { background: red500.rgbString(), color: white.rgbString() },
    footer: { green50: red500.rgbString(), color: white.rgbString() },
    header: {
      background: red500.rgbString(),
      color: white.rgbString(),
      withTitle: { background: "none", color: textBlack.rgbString() }
    },
    body: {
      day: {
        hover: { background: red200.rgbString(), color: white.rgbString() },
        inactive: {
          background: grey
            .clone()
            .lighten(0.82)
        ...
        selected: { background: red300.rgbString(), color: white.rgbString() }
      },
      today: {
    ...
    event: {
      ...
      hover: { background: purple400.rgbString(), color: white.rgbString() }
    }
  },
  table: {
